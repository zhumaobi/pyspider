...
def login(url):
    login_name = raw_input('请输入QQ号\n')
    login_password = raw_input('请输入QQ密码\n')
...
"""------------------登陆之后进行好友留言-----------------
"""
    qqzonelink = driver.find_element_by_tag_name('a')
    qqzonelink.click()
    driver,get('https://user.qzone.qq.com/674484861')
...
if __name__ == '__main__':
    ...
    # 验证cookie是否正确
    """myspace = 'http://user.qzone.qq.com/736376329'
